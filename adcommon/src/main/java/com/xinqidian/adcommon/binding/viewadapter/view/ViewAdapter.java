package com.xinqidian.adcommon.binding.viewadapter.view;
...
public class ViewAdapter {
    ...
    public static void onClickCommand(View view, final BindingCommand clickCommand, final boolean isThrottleFirst) {
        final WeakReference<BindingCommand> weakReference=new WeakReference<BindingCommand>(clickCommand);
        KLog.e("onClickCommand--->","onClickCommand");
        if (isThrottleFirst) {
            RxView.clicks(view)
