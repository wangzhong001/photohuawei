...
public class Contants {
    ...
    /** 开屏延长进入主页面时间 默认两秒 */
    public static int SPLASH_TO_MAIN_TIME = 2000;


    /** 激励视频展示次数 */
    public static String SHOW_STIMULATE_NUMBER_STRING = "SHOW_STIMULATE_NUMBER_STRING";

    public static int SHOW_STIMULATE_NUMBER = 5;
    ...
    /** qq*/
    public static String QQ = "604416495";


    /** 平台*/
    public static String PLATFORM= "huawei";
//    public static String PLATFORM= "华为";
    ...
    public static String BASE_URL ="http://47.114.151.208:8081/" ;


    public static String photoPrice="1.00";
    ...
    public static String photoPriceString="photoPriceString";
