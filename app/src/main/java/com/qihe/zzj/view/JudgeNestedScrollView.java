...
/**
 * Created by lipei on 2020/7/25.
 */

public class JudgeNestedScrollView  extends FrameLayout implements NestedScrollingParent,
    ...
    public interface OnScrollChangeListener {
         ...
         */
        void onScrollChange(JudgeNestedScrollView v, int scrollX, int scrollY,
    ...
    private JudgeNestedScrollView.SavedState mSavedState;

    private static final JudgeNestedScrollView.AccessibilityDelegate ACCESSIBILITY_DELEGATE = new JudgeNestedScrollView.AccessibilityDelegate();
    ...
    private JudgeNestedScrollView.OnScrollChangeListener mOnScrollChangeListener;
     ...
     */
    public void setOnScrollChangeListener(@Nullable JudgeNestedScrollView.OnScrollChangeListener l) {
...
//                mIsBeingDragged = !mScroller.isFinished();
    ...
    protected void onRestoreInstanceState(Parcelable state) {
        if (!(state instanceof JudgeNestedScrollView.SavedState)) {
            super.onRestoreInstanceState(state);
            return;
        }

        JudgeNestedScrollView.SavedState ss = (JudgeNestedScrollView.SavedState) state;
    ...
    protected Parcelable onSaveInstanceState() {
        ...
        JudgeNestedScrollView.SavedState ss = new JudgeNestedScrollView.SavedState(superState);
    ...
    static class SavedState extends BaseSavedState {
        ...
        public static final Parcelable.Creator<JudgeNestedScrollView.SavedState> CREATOR =
                new Parcelable.Creator<JudgeNestedScrollView.SavedState>() {
                    @Override
                    public JudgeNestedScrollView.SavedState createFromParcel(Parcel in) {
                        return new JudgeNestedScrollView.SavedState(in);
                    }

                    @Override
                    public JudgeNestedScrollView.SavedState[] newArray(int size) {
                        return new JudgeNestedScrollView.SavedState[size];
                    }
                };
    }
    ...
    static class AccessibilityDelegate extends AccessibilityDelegateCompat {
        ...
        public boolean performAccessibilityAction(View host, int action, Bundle arguments) {
            ...
            final JudgeNestedScrollView nsvHost = (JudgeNestedScrollView) host;
