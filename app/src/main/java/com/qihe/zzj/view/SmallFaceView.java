...
public class SmallFaceView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawBitmapMesh(noChnageBitMap, WIDTH, HEIGHT, orig, 0, null, 0, null);
    ...
    public Bitmap getNoChnageBitMap() {
        ...
        if(noChnageBitMap == null) return null;
        Bitmap copy = Bitmap.createBitmap(noChnageBitMap.getWidth(), noChnageBitMap.getHeight(), Bitmap.Config.ARGB_8888);
        Canvas canvas = new Canvas(copy);
        canvas.drawBitmapMesh(noChnageBitMap, WIDTH, HEIGHT, verts, 0, null, 0, null);
        return copy;

    }

    public void setNoChnageBitMap(Bitmap noChnageBitMap) {
        this.noChnageBitMap = noChnageBitMap;
    }
