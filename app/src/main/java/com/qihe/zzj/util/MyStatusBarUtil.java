...
//        | View.SYSTEM_UI_FLAG_IMMERSIVE);
    ...
    public static void setColorSecial(Activity activity, @ColorInt int color) {
    ...
    /*
     * 设置状态栏透明,然后动态添加一个view填充上去,高度是动态获取状态栏高度
     * view,填充的view
     */
    public static void setStatusBarHide(Activity activity,View view){
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
            //透明状态栏
            activity.getWindow().addFlags(WindowManager.LayoutParams.FLAG_TRANSLUCENT_STATUS);
            //透明导航栏
